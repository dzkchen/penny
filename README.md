...
- `D018`: DOM XSS sinks in client code — dynamic `innerHTML`/`outerHTML`, `dangerouslySetInnerHTML`, `v-html`, `insertAdjacentHTML`, or `document.write` (static markup is not flagged).
